...
from sodar_cli.landingzone.retrieve import (
...
from sodar_cli.landingzone.validate import (
    setup_argparse as setup_argparse_validate,
)
...
def setup_argparse(parser: argparse.ArgumentParser) -> None:
    ...
    setup_argparse_validate(subparsers.add_parser("validate", help="Validate landing zone (async)."))
